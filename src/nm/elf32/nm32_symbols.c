...
/*   Updated: 2026/03/25 09:17:44 by odudniak         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_nm.h"

static int	nm32_is_readonly(Elf32_Word sh_flags, Elf32_Word sh_type)
{
...
static void	nm32_check_section(t_nm_symbol *symbol,
	Elf32_Shdr *s)
{
	const Elf32_Word	sh_type = s->sh_type;
	const Elf32_Word	sh_flags = s->sh_flags;
...
static void	nm32_identify_symbol(Elf32_Sym *sym, Elf32_Shdr *shdr,
	t_nm_symbol *symbol)
{
	...
	if (sym->st_shndx == SHN_UNDEF)
		...
		nm32_check_section(symbol, &shdr[sym->st_shndx]);
}
